...
ttk.Button(app, text='Isko Click kado', command=abc).place(x=100, y=100)
ttk.Button(app, text='Ye wala bhi hai', font=('Arial', 22),
           command=lambda: msg.set('pta nhi')).place(x=100, y=130)
